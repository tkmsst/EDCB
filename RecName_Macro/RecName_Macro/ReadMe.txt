========================================================================
 ダイナミック リンク ライブラリ: RecName_Macro プロジェクトの概要
========================================================================

この RecName_Macro DLL は、AppWizard により作成されました。

このファイルには、RecName_Macro 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


RecName_Macro.vcxproj
