========================================================================
    Win32 アプリケーション: EpgTimerSrv プロジェクトの概要
========================================================================

この EpgTimerSrv アプリケーションは、AppWizard により作成されました。

このファイルには、EpgTimerSrv 
...
EpgTimerSrv.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル EpgTimerSrv.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル EpgTimerSrv.rc 
    にインクルードされます。
